...
#include "Vampire_Game_UE5/TP_WeaponComponent.h"
...
VAMPIRE_GAME_UE5_API UClass* Z_Construct_UClass_UTP_WeaponComponent();
VAMPIRE_GAME_UE5_API UClass* Z_Construct_UClass_UTP_WeaponComponent_NoRegister();
...
struct Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon_Statics
{
	...
	{
		AVampire_Game_UE5Character* TargetCharacter;
		bool ReturnValue;
	};
#if WITH_METADATA
...
{
	P_GET_OBJECT(AVampire_Game_UE5Character,Z_Param_TargetCharacter);
	P_FINISH;
	P_NATIVE_BEGIN;
...
struct Z_Construct_UClass_UTP_WeaponComponent_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UTP_WeaponComponent_AttachWeapon, "AttachWeapon" }, // 2722211598
...
template<> VAMPIRE_GAME_UE5_API UClass* StaticClass<UTP_WeaponComponent>()
{
	return UTP_WeaponComponent::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_MarcusPersson_Documents_Unreal_School_Vampire_Game_Unreal_Vampires_Vampire_Game_UE5_Source_Vampire_Game_UE5_TP_WeaponComponent_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UTP_WeaponComponent, UTP_WeaponComponent::StaticClass, TEXT("UTP_WeaponComponent"), &Z_Registration_Info_UClass_UTP_WeaponComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UTP_WeaponComponent), 4218061631U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_MarcusPersson_Documents_Unreal_School_Vampire_Game_Unreal_Vampires_Vampire_Game_UE5_Source_Vampire_Game_UE5_TP_WeaponComponent_h_2572842573(TEXT("/Script/Vampire_Game_UE5"),
	Z_CompiledInDeferFile_FID_Users_MarcusPersson_Documents_Unreal_School_Vampire_Game_Unreal_Vampires_Vampire_Game_UE5_Source_Vampire_Game_UE5_TP_WeaponComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_MarcusPersson_Documents_Unreal_School_Vampire_Game_Unreal_Vampires_Vampire_Game_UE5_Source_Vampire_Game_UE5_TP_WeaponComponent_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
